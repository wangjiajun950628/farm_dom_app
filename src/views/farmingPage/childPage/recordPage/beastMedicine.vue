                ...
                <van-row gutter="20">
                    <van-col span="24">
                        <div class="co-data-list-box">
                            <span>兽药名称：</span><span class="co-data-value">测试0827777</span>
                        </div>
                    </van-col>
                    <van-col span="24">
                        <div class="co-data-list-box">
                            <span>发病原因：</span><span class="co-data-value">应急</span>
                        </div>
                    </van-col>
                    <van-col span="24">
                        <div class="co-data-list-box">
                            <span>诊断结果：</span><span class="co-data-value">公司自查</span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                    ...
                    <van-col span="12">
                        <div class="co-data-list-box">
                            <span>用药时间：</span><span class="co-data-value">2019-09-23</span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                            <span>停药时间：</span><span class="co-data-value">2019-09-23</span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                            <span>休药日期：</span><span class="co-data-value">2019-09-23</span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                            <span>操作人：</span><span class="co-data-value">王五</span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                            <span>用药剂量：</span><span class="co-data-value"></span>
                        </div>
                    </van-col>
                    <van-col span="24">
                        <div class="co-data-list-box">
