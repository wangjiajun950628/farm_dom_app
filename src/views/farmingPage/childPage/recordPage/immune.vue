                ...
                <van-row gutter="20">
                    <van-col span="24">
                        <div class="co-data-list-box">
                            <span>疫苗名称：</span><span class="co-data-value">测试0827777</span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                    ...
                    <van-col span="12">
                        <div class="co-data-list-box">
                            <span>免疫时间：</span><span class="co-data-value">2019-09-23</span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                    ...
                    <van-col span="24">
                        <div class="co-data-list-box">
                            <span>免疫方法：</span><span class="co-data-value"></span>
                        </div>
                    </van-col>
                    <van-col span="12">
                        <div class="co-data-list-box">
                            <span>操作员：</span><span class="co-data-value"></span>
                        </div>
                    </van-col>
                    <van-col span="24">
                        <div class="co-data-list-box">
